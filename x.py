...
def delete_user_email(receiver_email, user_id):
    try:
        sender_email = "freja.peulicke@gmail.com"
        password = "pliyoscaqcaahfjq"   
        message = MIMEMultipart("alternative")
        ...
        Click here to DELETE your account: {domain}/delete-user/{user_id}"""
        html = f"""\
        <html>
        <body>
            <p>Hi,<br>
            Are you sure you want to delete your account!<br>
            <a href="{domain}/delete-user/{user_id}">Click here to DELETE</a>
            </p>
        </body>
        </html>
        """   
